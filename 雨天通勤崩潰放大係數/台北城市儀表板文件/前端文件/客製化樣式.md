...
如果您對地圖（Mapbox）的樣式感興趣，請參考[客製化地圖](/documentation/front-end/custom-maps)文章。

> #### 警告 - 1
>
> 協作者請注意，在修改本專案時，有一些全域和局部樣式是不允許被修改的。另外，我們也制定了[設計指南](/documentation/front-end/design-guide)，如果您希望對本專案貢獻新元素，應遵循該指南。
...
[auto\_fix\_high於Github編輯此文章](https://github.com/taipei-doit/Taipei-City-Dashboard-Documentation/edit/main/src/assets/articles/front-end-ch/custom-styling.md)
...
###### 客製化彈跳視窗](/documentation/front-end/custom-dialogs)