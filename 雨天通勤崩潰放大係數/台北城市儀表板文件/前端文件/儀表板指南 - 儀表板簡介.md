...
[`GET` `/api/v1/dashboard`](/documentation/back-end/dashboard-apis) [`DB` `dashboardmanager.dashboards`](/documentation/back-end/dashboards-db)
...
[auto\_fix\_high於Github編輯此文章](https://github.com/taipei-doit/Taipei-City-Dashboard-Documentation/edit/main/src/assets/articles/front-end-ch/introduction-to-dashboards.md)

[##### keyboard\_arrow\_left前一篇文章

###### 畫面渲染策略](/documentation/front-end/rendering-strategy)
