...
錯誤回報(Bug Report) [#](#錯誤回報(bug-report))
---------------------------------------
...
新功能請求(Feature Request) [#](#新功能請求(feature-request))
---------------------------------------------------
...
重構請求(Refactor Request) [#](#重構請求(refactor-request))
---------------------------------------------------
...
[auto\_fix\_high於Github編輯此文章](https://github.com/taipei-doit/Taipei-City-Dashboard-Documentation/edit/main/src/assets/articles/data-end-ch/open-an-issue.md)
...
###### 開立 Pull Request](/documentation/data-end/open-a-pull-request)