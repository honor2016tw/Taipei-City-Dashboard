...
> #### 警告 - 1
>
> 請務必確認你已根據[下載並設定專案](/documentation/data-end/project-setup)章節部屬成功。
...
> #### 資訊 - 1
>
> `_mtime` 是該列資料的最後修改時間，欄位說明可見上一章[資料流表格](/documentation/data-end/dag-table)。

[auto\_fix\_high於Github編輯此文章](https://github.com/taipei-doit/Taipei-City-Dashboard-Documentation/edit/main/src/assets/articles/data-end-ch/dag-test.md)
