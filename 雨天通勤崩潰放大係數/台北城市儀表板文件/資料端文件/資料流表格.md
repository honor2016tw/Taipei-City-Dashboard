...
詳細說明請參閱[通用函式-建表 SQL](/documentation/data-end/utils-generate_sql)章節。

[auto\_fix\_high於Github編輯此文章](https://github.com/taipei-doit/Taipei-City-Dashboard-Documentation/edit/main/src/assets/articles/data-end-ch/dag-table.md)
