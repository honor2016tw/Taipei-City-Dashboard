...
### -函式 convert\_str\_to\_time\_format(time\_column) [#](#-函式-convert_str_to_time_format(time_column))
...
### -函式 omit\_chinese\_string\_in\_time(x) [#](#-函式-omit_chinese_string_in_time(x))
...
[auto\_fix\_high於Github編輯此文章](https://github.com/taipei-doit/Taipei-City-Dashboard-Documentation/edit/main/src/assets/articles/data-end-ch/utils-transform-time.md)
