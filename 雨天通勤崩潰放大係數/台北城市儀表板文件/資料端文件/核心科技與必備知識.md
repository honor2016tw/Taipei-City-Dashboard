...
本專案使用的 Python 版本為 3.8，使用套件可以在下章節[下載並設定專案](/documentation/data-end/project-setup)完成後，於本專案路徑的`/requirements.txt`找到。
其中幾個關鍵的套件說明如下：
...
[auto\_fix\_high於Github編輯此文章](https://github.com/taipei-doit/Taipei-City-Dashboard-Documentation/edit/main/src/assets/articles/data-end-ch/prerequisites.md)

[##### keyboard\_arrow\_left前一篇文章

###### 儀表板簡介](/documentation/data-end/introduction)

[##### 下一篇文章keyboard\_arrow\_right

###### 下載並設定專案](/documentation/data-end/project-setup)