...
looks\_one 已確認過程式檢查器（Pylint）並解決所有能解決的提示
...
[auto\_fix\_high於Github編輯此文章](https://github.com/taipei-doit/Taipei-City-Dashboard-Documentation/edit/main/src/assets/articles/data-end-ch/open-a-pull-request.md)

[##### keyboard\_arrow\_left前一篇文章

###### 開立 Issue](/documentation/data-end/open-an-issue)