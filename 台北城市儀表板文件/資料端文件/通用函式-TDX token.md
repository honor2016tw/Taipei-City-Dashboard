...
```
content_paste# Get Taipei YouBike stations from TDX
import requests
import pandas as pd
...
```
content_paste>>> print(tpe_data.iloc[0])
...
[auto\_fix\_high於Github編輯此文章](https://github.com/taipei-doit/Taipei-City-Dashboard-Documentation/edit/main/src/assets/articles/data-end-ch/utils-tdx.md)

[##### keyboard\_arrow\_left前一篇文章

###### 通用函式-儲存階段](/documentation/data-end/utils-load)

[##### 下一篇文章keyboard\_arrow\_right

###### 協作方式概覽](/documentation/data-end/contribution-overview)