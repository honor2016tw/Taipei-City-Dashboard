...
```
content_pastedialogs: { // dialogStore 其中一個狀態
...
### 彈跳視窗Vue元件的結構 [#](#彈跳視窗vue元件的結構)

以下是一個典型的彈跳視窗Vue元件的架構。

```
content_paste<template>
...
```
content_paste<style scoped lang="scss">
    .dialogcontainer {
        /* 占滿整個畫面 */
...
[auto\_fix\_high於Github編輯此文章](https://github.com/taipei-doit/Taipei-City-Dashboard-Documentation/edit/main/src/assets/articles/front-end-ch/custom-dialogs.md)

[##### keyboard\_arrow\_left前一篇文章

###### 客製化樣式](/documentation/front-end/custom-styling)
