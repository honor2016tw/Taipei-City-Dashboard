...
###### Chart and History Data](https://www.youtube.com/watch?v=1OARa32Ay3o)[play\_circle

##### 新增圖表樣式 文字單位圖 3.0

###### New version of chart TextUnitChart3.0](https://www.youtube.com/watch?v=hRoRASJOnPo)

支援的資料類型 [#](#支援的資料類型)
---------------------

本專案目前支援 5 種圖表資料類型。每種資料類型都有預定的格式並支援一組圖表。如要了解更多有關各圖表類型的資訊，請參考[下一篇文章](/documentation/front-end/supported-chart-types)。

[`GET` `/api/v1/component/:id/chart`](/documentation/back-end/component-data-apis) [`DB` `dashboardmanager.components`](/documentation/back-end/components-db)

### 二維資料 (two\_d) [#](#二維資料-(two_d))
...
> #### 資訊 - 2
>
> 有關捷運行駛圖的 key-value 格式，請參[下一篇文章](/documentation/front-end/supported-chart-types#metro-chart)。

### 三維資料 (three\_d) [#](#三維資料-(three_d))
...
> #### 資訊 - 3
>
> 有關指標圖的 key-subcategory-value 格式，和文字單位圖的具體應用方式請參[下一篇文章](/documentation/front-end/supported-chart-types)。

### 時間序列資料 (time) [#](#時間序列資料-(time))
...
### 圖例資料 (map\_legend) [#](#圖例資料-(map_legend))
...
[auto\_fix\_high於Github編輯此文章](https://github.com/taipei-doit/Taipei-City-Dashboard-Documentation/edit/main/src/assets/articles/front-end-ch/chart-data.md)

[##### keyboard\_arrow\_left前一篇文章

###### 組件簡介](/documentation/front-end/introduction-to-components)
