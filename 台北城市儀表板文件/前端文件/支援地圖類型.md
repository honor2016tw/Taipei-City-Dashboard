...
###### Map Config 3.0](https://www.youtube.com/watch?v=wnWVfjs1bEU)
...
[`DB` `dashboardmanager.component_maps`](/documentation/back-end/components-db)
...
[auto\_fix\_high於Github編輯此文章](https://github.com/taipei-doit/Taipei-City-Dashboard-Documentation/edit/main/src/assets/articles/front-end-ch/supported-map-types.md)
