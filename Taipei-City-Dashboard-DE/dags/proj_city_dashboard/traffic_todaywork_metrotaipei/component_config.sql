...
VALUES (
    ...
    10,
    'minute',
    '臺北市政府工務局 / 新北市政府道路挖掘資訊',
    '顯示目前雙北道路施工與道路挖掘案件的行政區分布。',
    '整合臺北市今日施工資訊與新北市道路挖掘案件資料，統計目前雙北各行政區的施工案件數。臺北市資料取自臺北市政府工務局 Todaywork.json；新北市資料取自新北市政府道路挖掘資訊，並以案件施工起訖日期判斷今日仍有效的案件。圖表可切換行政區圖與橫向長條圖，用於快速掌握施工熱區與跨市通勤路廊可能受影響的位置。',
